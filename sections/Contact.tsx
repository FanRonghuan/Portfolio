    ...
    return (
        ...
        >
            ...
            >
                ...
                {/* --- MAIN CARD --- */}
                <div 
                    className="absolute inset-0 bg-white/5 backdrop-blur-md border border-white/10 rounded-[2rem] overflow-hidden shadow-2xl flex flex-col items-center justify-center text-center transition-colors duration-300"
                    style={{ 
                        backgroundColor: isHovered ? 'rgba(255,255,255,0.9)' : 'rgba(255,255,255,0.05)',
                        borderColor: isHovered ? 'rgba(255,255,255,1)' : 'rgba(255,255,255,0.1)'
                    }}
                >
                    ...
                    <motion.div
                        animate={{ 
                            ...
                            opacity: isHovered ? (item.qrCode ? 0 : 1) : 0.8
                        }}
                ...
                >
                    {/* Replaced 'HELLO' with Floor Marquee */}
                     <FloorMarquee 
                        ...
                        text="CONTACT ME" 
                        rotate={-10} 
                        className="text-[120px] md:text-[180px] font-albert-black text-white/5 leading-none" 
