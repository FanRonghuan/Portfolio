...
const mixedData: ExperienceItem[] = [
  {
    ...
    role: '多媒体设计实习生',
    company: '腾讯科技有限公司',
    description: '1. 美学评调体系构建：参与WXG基础视觉训练的中式审美约开源框架搭建，调研HPSv3等行业主流评测方法的适配性，优化层成组合团队需求的量化估价标准；2. 数据物法与质量管控：负责内部平台Prompt Tag多场景的数据整理、构建可实施的美学评估体系，并推进素材图像数据採集，有效提升样模与风格泛化能力。',
  ...
  },
  {
    ...
    role: '电商设计实习生',
    company: '拓莱雅化妆品股份有限公司',
    description: '1. 大促视觉全链路设计：深度参与618大促、七夕、双十一等多场大促电商营销活动的独立完成设计，实现大促物料交付100%；2. 电商直播品牌活动：参与电商直播页与新营馆设计，负责产品包装拍摄、电商详情页等核心创意工作。',
    tags: ['电商设计', '品牌视觉', '直播设计'],
    type: 'work'
  },
  {
    ...
    role: '视觉设计实习生',
    company: '美图公司',
    description: '1. 产品视觉创意落地：负责美图设计室在线平台的浅营活动设计及系列海报创作，独立完成多系列产品视觉方案；2. AIGC内容生成平台UI：针对AIGC工具集的营销物料创作，创新设计产业模式，实现设计效率提升40%。',
  ...
  },
  {
    ...
    role: '硕士研究生',
    company: '湖北大学',
    description: '视觉传达设计硕士在读，主修课程：圆形创意设计、设计伦文写作及方法论、设计管理与策划、企业争战略策划等。GPA：专业排名前20%，获学年二、三等奖学金',
    tags: ['硕士学位', '视觉传达', '学术研究'],
    type: 'edu'
  },
  {
    ...
    role: '本科生',
    company: '湖南涉外经济学院',
    description: '视觉传达设计本科，主修课程：设计基础、色彩设计、海报设计、包装设计、辅助设计、插画设计等。GPA: 3.77，专业排名前8%，获校一等奖学金',
